...
// 그러나, 배열을 이용하면 일일이 변수를 선언할 필요 없이 한 방에 선언되고, 초기화 값도 한 방에 세팅해준다.
// 배열을 동일한 데이터 타입의 값들을 하나의 배열명으로 저장시킬 수 있는 아주 편리한 자료구조이다.
...
public class Java100_array_Basic001 {
	public static void main(String[] args) {
		...
		// [4-2] : 두 번째 방식
		double sales_table2[];	//double[] sales_table2 도 가능. 배열을 선언할 때 괄호 위치는 통일시킬 것
		...
		System.out.println(sales_table2[99]);	// 0.0
	}
}