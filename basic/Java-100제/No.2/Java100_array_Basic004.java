...
// 이 문제는 배열 선언과 동시에 특정 값으로 초기화할 수 있는지를 묻는 문제이다.
// 이때, 2가지 방식으로 초기화를 할 수 있으니 이를 모두 작성하시오.

public class Java100_array_Basic004 {
	public static void main(String[] args) {
		
		// [1] : 배열 선언과 동시에 특정 값으로 초기화
		int[] sales_table = {55, 88, 60, 100, 90}; // new int[5];
		...
		// [3]
		int[] sales_table3;
		// sales_table3 = {55, 88, 60, 100, 90};	// error
