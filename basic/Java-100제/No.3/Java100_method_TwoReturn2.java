// 반환값이 두 개 있는 메서드를 구현해보시오.
// 메서드는 ("korea", "USA") 입력 시 소문자는 대문자로, 대문자는 소문자로 출력되도록 구현한다.
// 이 문제는 자바의 메서드 작성 시 리턴되는 반환값이 두 개일 때 처리하는 방법을 아는지에 대해서 묻는 문제이다.
...
public class Java100_method_TwoReturn2 { 
	...
	public static String[] capitalMethod(String a, String b) {
		String alpha = a.toUpperCase();
		String beta = b.toLowerCase();
		
		System.out.println(alpha);
		System.out.println(beta);
		
		// 리턴값 두 개를 저장할 배열 변수 선언
		String[] ret = {alpha, beta};
		return ret;
	}
