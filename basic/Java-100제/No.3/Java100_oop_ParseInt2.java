// 문자열을 숫자로 변환 시 진수를 지정해서 출력해보시오
// 이 문제는 Integer.parseInt()의 두 번째 인자값으로 진수를 지정하여 출력하는 것에 대해서 묻는 문제이다.

// [!] : 변환이 왜 필요한가?
// 1 + 2에서 숫자끼리의 연산은 3이지만, 문자열끼리의 연산은 12가 되기 때문에 숫자로 변환 후 연산을 수행해야 한다.
...
public class Java100_oop_ParseInt2 {
	public static void main(String[] args) {
		...
		System.out.println(Integer.parseInt("2022",8));		// 8진수를 10진수로, 1042
